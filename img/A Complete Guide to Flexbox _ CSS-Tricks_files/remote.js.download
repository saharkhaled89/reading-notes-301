...
c=g.W(b,128)?g.gN("Error on $RECEIVER_NAME",c):g.xD(b)||g.W(b,4)?g.gN("Playing on $RECEIVER_NAME",c):g.gN("Connected to $RECEIVER_NAME",c);a.ha("statustext",c);a.u.show()}else a.u.hide()},O8=function(a,b){g.$O.call(this,"Play on",0,a,b);
